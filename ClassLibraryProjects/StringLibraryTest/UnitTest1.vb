...
Imports StringLibrary.UtilityLibraries
...
Namespace StringLibraryTest
    ...
    Public Class UnitTest1
        ...
        Public Sub DirectCallWithNullOrEmpty()
            ...
            For Each word In words
                Dim result As Boolean = StringLibrary.UtilityLibraries.StartsWithUpper(word)
                Assert.IsFalse(result, $"Expected for '{If(word Is Nothing, "<null>", word)}': false; Actual: {result}")
            Next
        End Sub
